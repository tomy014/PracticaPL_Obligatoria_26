...
// <decsubprog> ::= (decproc | decfun)* | ε
// <sentlist> ::= sent+
// <dcl> ::= defcte | defvar
// <defcte> ::= ( tipo ',' 'PARAMETER' '::' IDENT '=' simpvalue ';' )* | ε
// <ctelist> ::= ( IDENT '=' simpvalue ',' )* IDENT '=' simpvalue | ε
// <simpvalue> ::= NUM_INT_CONST | NUM_REAL_CONST | STRING_CONST
// <mixedvalue> ::= NUM_INT_CONST '::' NUM_REAL_CONST
// <defvar> ::= ( tipo '::' varlist ';' )* | ε
...
// <nomparamlist> ::= IDENT (',' IDENT)* | ε
// <dec_s_paramlist> ::= ( tipo ',' 'INTENT' '(' tipoparam ')' IDENT ';' )* | ε
// <tipoparam> ::= 'IN' | 'OUT' | 'INOUT'
// <decfun> ::= 'FUNCTION' IDENT '(' nomparamlist ')' tipo '::' IDENT ';' dec_f_paramlist 'END' 'FUNCTION' IDENT
// <dec_f_paramlist> ::= ( tipo ',' 'INTENT' '(' 'IN' ')' IDENT ';' )* | ε
...
defcte : ( tipo ',' 'PARAMETER' '::' IDENT '=' simpvalue ';' )* ;
ctelist : ( IDENT '=' simpvalue ',' )* IDENT '=' simpvalue | /* empty */ ;
